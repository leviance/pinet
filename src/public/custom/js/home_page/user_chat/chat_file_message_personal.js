let form_data_user_send_file_image_personal = null
...
function remove_image_from_preview(){
  $('.btn-remove-file-img').unbind('click').bind('click', function(){
    ...
    form_data_user_send_file_image_personal = null
    $(this).parent().remove()
  })
}

function preview_file_image_before_send(images){
...
function user_send_file_image(){
  $.ajax({
      ...
      contentType: false,
      processData: false,
      data: form_data_user_send_file_image_personal,
...
$(document).ready(function(){
  ...
  $('#sub-btn-user-send-image').on('change', function(event){
    ...
    $('#chat-frame .preview-file-attachment').show()
    preview_file_image_before_send(images)
    ...
    form_data_user_send_file_image_personal = form_data
  })
